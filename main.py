...
print(len(my_tuple))
my_tuple3 = (1,2,2,2,2,2,2,2,2,2,2,2,2,2,2,3,3,4,5,6,7,7,7,7,7,8,9)
print(my_tuple3.count(2))
my_tuple4 = ('a', 'a', 'a','b','c', 'c')
...
raffle.add("Banana")
raffle.add("Apple")
raffle.add("Sandwochc")
print(raffle)
#################################################booleans######################################################
# booleans
# a boolean can only have 2 values -- true or False
bool = 5 > 2.5435345478492130213890473895348923721479534
print(bool)
# my_bool = 5 > 4
#print(my_bool)
